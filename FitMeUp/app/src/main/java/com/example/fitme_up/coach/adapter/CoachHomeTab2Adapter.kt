...
class CoachHomeTab2Adapter(private val myDataset: List<CoachingData>, private val parentFragment: Fragment) : RecyclerView.Adapter<CoachHomeTab2Adapter.MyViewHolder>(),
