...
class LfgTab2Adapter(private val myDataset: List<LfgData>, private val parentFragment: Fragment) :
    RecyclerView.Adapter<LfgTab2Adapter.MyViewHolder>(), OnButtonClickListener {

    class MyViewHolder(itemView: View, private val listener: OnButtonClickListener) :
