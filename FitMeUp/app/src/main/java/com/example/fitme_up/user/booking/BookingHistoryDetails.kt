...
class BookingHistoryDetails : Fragment() {

    private lateinit var viewPager: ViewPager2
    private lateinit var venueDesc: TextView
    ...
    override fun onCreateView(
        ...
        val view = inflater.inflate(R.layout.fragment_booking_history_details, container, false)

        viewPager = view.findViewById(R.id.venuePager)
        venueDesc = view.findViewById(R.id.text_venue_desc)
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        venueDesc.movementMethod = ScrollingMovementMethod()
