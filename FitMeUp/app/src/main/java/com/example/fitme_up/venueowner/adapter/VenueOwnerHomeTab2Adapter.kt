...
class VenueOwnerHomeTab2Adapter(private val myDataset: List<VenueOwnerBookData>, private val parentFragment: Fragment) : RecyclerView.Adapter<VenueOwnerHomeTab2Adapter.MyViewHolder>(),
    ...
    override fun onBindViewHolder(holder: MyViewHolder, position: Int) {
        ...
        holder.textView3.setBackgroundResource(R.drawable.venue_on_progress)
    }
