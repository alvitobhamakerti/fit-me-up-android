...
import com.example.fitme_up.user.booking.BookingHistoryDetails
import com.example.fitme_up.user.dataset.HistoryData

class BookingHistoryTab2Adapter(private val myDataset: List<HistoryData>, private val parentFragment: Fragment) : RecyclerView.Adapter<BookingHistoryTab2Adapter.MyViewHolder>(),
    ...
    override fun onButtonClick() {
        val newFragment = BookingHistoryDetails()
